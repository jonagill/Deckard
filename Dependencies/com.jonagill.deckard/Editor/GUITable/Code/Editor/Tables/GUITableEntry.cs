...
namespace EditorGUITable
{
	...
	public class GUITableEntry
	{
		...
		public bool rotateHeaders = false;
		public float defaultColumnWidth = 0f;
			...
			foreach (GUITableOption option in options)
			{
				switch (option.type)
				{
					...
					case GUITableOption.Type.Filter:
						...
						break;
					case GUITableOption.Type.RotateHeaders:
						this.rotateHeaders = (bool)option.value;
						break;
					case GUITableOption.Type.DefaultColumnWidth:
						this.defaultColumnWidth = (float)option.value;
						break;
				}
			}
		}
