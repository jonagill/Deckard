...
namespace EditorGUITable
{
	...
	public class GUITableOption
	{
		...
		public static GUITableOption RotateHeaders(bool enable)
		{
			return new GUITableOption(Type.RotateHeaders, enable);
		}

		public static GUITableOption DefaultColumnWidth(float width)
		{
			return new GUITableOption(Type.DefaultColumnWidth, width);
		}
	}
