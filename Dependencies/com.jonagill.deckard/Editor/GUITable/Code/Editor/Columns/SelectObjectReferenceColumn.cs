...
namespace EditorGUITable
{
	...
	{
		public SelectObjectReferenceColumn (params TableColumnOption[] options) : base (options)
		{
		}

		[System.Obsolete ("Use SelectObjectReferenceColumn(options) instead, with the option TableColumn.Title()")]
