...
namespace EditorGUITable
{
	...
	public class ReorderableTableAttribute : TableAttribute
	{
		...
		public ReorderableTableAttribute (string[] properties, float[] widths, params string[] tableOptions) : base (properties, widths, tableOptions) {}
		...
		/// <param name="properties"> The properties to display in the table</param>
		/// <param name="widths"> The widths of the table's columns</param>
		public ReorderableTableAttribute (string[] properties, params string[] tableOptions) : base (properties, tableOptions) {}
