...
public class LogoTableEditor : Editor 
{
	...
	public override void OnInspectorGUI ()
	{
		...
		{
			new TableColumn(TableColumn.Title("G"), TableColumn.Width(28f)),
			new TableColumn(TableColumn.Title("U"), TableColumn.Width(22f)),
			new TableColumn(TableColumn.Title("I     "), TableColumn.Width(35f)),
		};
